...
app = FastAPI(
    ...
    version="2.2.0",
    description=("Plataforma Cuantitativa Dual REAL-ONLY: TRACK_FONDEO (CME Futures / Preservación de Capital) & TRACK_ULTRA (Multi-Asset Registry-Driven). Motor desacoplado con AsyncEventBus, QVF Evidence Gate y Streaming SSE."),
    lifespan=lifespan,
)
