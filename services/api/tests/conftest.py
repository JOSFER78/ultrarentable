"""Pytest isolation: never read or mutate the operational SQLite database."""
...
_TEST_DB_PATH = (
    ...
    / f"ultrarentable-pytest-{os.getpid()}.sqlite3"
)
...
# Clone a transactionally consistent, read-only baseline before application modules
# are imported. Tests mutate only this disposable copy.
