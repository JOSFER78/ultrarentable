...
export default function StrategiesPage() {
  ...
  const statuses = useMemo(() => Array.from(new Set(items.map((x) => x.validation_status).filter((s): s is string => Boolean(s)))).sort((a,b) => (ORDER.indexOf(a as never) + 99) - (ORDER.indexOf(b as never) + 99)), [items]);
