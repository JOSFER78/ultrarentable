  ...
  return (
    <div className="space-y-4 font-sans">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl md:text-2xl font-black text-[var(--text-1)] tracking-tight">Conexión Gateway & Brokers CME</h1>
      ...
      {notification && (
        ...
        >
          {notification.isError ? <AlertTriangle className="w-4 h-4 text-[var(--loss)]" /> : <CheckCircle2 className="w-4 h-4 text-[var(--profit)]" />}
          {notification.text}
        </div>
      )}
      ...
      {!user && !authLoading && (
        <div className="p-4 bg-[var(--surface-2)] border border-[var(--border)] rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs font-mono text-[var(--text-1)] shadow-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold text-[var(--text-1)] text-sm">Sesión no iniciada</div>
          ...
          <button
            ...
            className="px-4 py-2 bg-[var(--surface-3)] hover:bg-[var(--surface-3)] text-[var(--text-1)] rounded-xl font-bold transition flex items-center gap-2 cursor-pointer shadow-lg  shrink-0"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="bg-[var(--surface-1)] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-5 shadow-xl space-y-4">
            <div className="flex items-center justify-between border-b border-white/[0.08] pb-3">
              <div className="flex items-center gap-2">
                <Key className="w-5 h-5 text-[var(--profit)]" />
                <h2 className="text-base font-bold text-[var(--text-1)] tracking-tight">
                  Credenciales de Cuenta en Firestore
                </h2>
              </div>
              <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-md bg-[var(--profit-dim)] border border-[var(--profit)] text-[var(--profit)]">
            ...
            <form onSubmit={handleSaveFirestoreConfig} className="space-y-4 font-mono text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="text-[10px] font-bold text-[var(--text-2)] uppercase tracking-wider block mb-1">
                    Broker / Plataforma
                  </label>
                  <select
                    value={broker}
                    onChange={(e) => setBroker(e.target.value)}
                    className="w-full bg-[var(--bg)] border border-white/[0.1] rounded-xl px-3 py-2.5 text-[var(--text-1)] font-bold focus:outline-none focus:border-[var(--profit)]"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[var(--bg)] border border-white/[0.1] rounded-xl px-3.5 py-2.5 text-[var(--profit)] font-bold placeholder:text-[var(--text-3)] focus:outline-none focus:border-[var(--profit)]"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[var(--bg)] border border-white/[0.1] rounded-xl px-3.5 py-2.5 text-[var(--text-1)] font-bold placeholder:text-[var(--text-3)] focus:outline-none focus:border-[var(--profit)]"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[var(--bg)] border border-white/[0.1] rounded-xl px-3.5 py-2.5 text-[var(--text-2)] font-bold placeholder:text-[var(--text-3)] focus:outline-none focus:border-[var(--profit)]"
                />
              </div>
              ...
              <div className="pt-2 flex items-center justify-between border-t border-white/[0.08]">
                <div className="text-[11px] text-[var(--text-2)]">
                  {saveSuccess && (
                    <span className="text-[var(--profit)] font-bold flex items-center gap-1">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="px-6 py-2.5 bg-[var(--surface-3)] hover:bg-[var(--surface-3)] text-[var(--text-1)] rounded-xl font-bold transition flex items-center gap-2 cursor-pointer shadow-lg  active:scale-95"
                >
          ...
          <div className="p-4 bg-[var(--bg)] rounded-2xl border border-white/[0.08] space-y-2 font-mono text-xs">
            <div className="text-[10px] text-[var(--text-2)] uppercase font-bold flex items-center gap-1">
              <Lock className="w-3.5 h-3.5 text-[var(--text-2)]" />
              Endpoint Webhook Oficial PickMyTrade API v2
            </div>
            <div className="flex items-center justify-between bg-[var(--surface-1)] p-2.5 rounded-xl border border-white/[0.08] text-[var(--text-1)]">
              ...
              <button
                ...
                className="ml-2 p-1.5 rounded-lg bg-[var(--bg)] border border-white/[0.08] text-[var(--text-2)] hover:text-[var(--text-1)] transition cursor-pointer"
                title="Copiar endpoint"
              >
                {copiedField === "webhook" ? <Check className="w-3.5 h-3.5 text-[var(--profit)]" /> : <Copy className="w-3.5 h-3.5" />}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-[var(--surface-1)] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-5 shadow-xl space-y-4">
            <div className="flex items-center justify-between border-b border-white/[0.08] pb-3">
              <div className="flex items-center gap-2">
                <Radio className="w-5 h-5 text-[var(--profit)] animate-pulse" />
                <h2 className="text-base font-bold text-[var(--text-1)] tracking-tight">
            ...
            <div className="space-y-3 font-mono text-xs">
              {/* Account ID & User */}
              <div className="p-3.5 bg-[var(--bg)] rounded-xl border border-white/[0.08] space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-[var(--text-2)] uppercase">Cuenta Activa:</span>
                  <strong className="text-[var(--profit)] text-sm">
                    {activeAccountId || "SIN VINCULAR"}
                  </strong>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-[var(--text-2)] uppercase">Operador:</span>
                  <span className="text-[var(--text-1)]">
                    {user?.email || profile?.displayName || "NO AUTENTICADO"}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-[var(--text-2)] uppercase">Broker / Entorno:</span>
                  <span className="text-[var(--text-1)]">
                    {broker} ({environment})
                  </span>
                </div>
              ...
              <div className="p-3.5 bg-[var(--bg)] rounded-xl border border-white/[0.08] space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-[var(--text-2)] uppercase">Saldo Base:</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-[var(--text-2)] uppercase">Trailing DD Límite:</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-[var(--text-2)] uppercase">Vencimiento Trial:</span>
              ...
              {/* Latency & Ping Button */}
              <div className="p-3.5 bg-[var(--bg)] rounded-xl border border-white/[0.08] text-center space-y-2">
                <div className="text-[10px] text-[var(--text-2)] uppercase">Latencia Física RTT</div>
                <div className="text-2xl font-black text-[var(--profit)] font-mono tabular-nums">
                ...
                <button
                  ...
                  className="w-full py-2 bg-[var(--surface-1)] hover:bg-[var(--surface-1)] text-[var(--text-1)] rounded-xl font-bold transition flex items-center justify-center gap-2 cursor-pointer active:scale-95"
                >
      ...
      <div className="bg-[var(--surface-1)] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-5 shadow-xl space-y-4">
        <div className="flex items-center justify-between border-b border-white/[0.08] pb-3">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-[var(--bg)] hover:bg-[var(--surface-1)] text-[var(--text-1)] border border-white/[0.1] text-xs font-mono font-bold transition flex items-center gap-1.5 cursor-pointer"
          >
            <RefreshCw className={`w-3.5 h-3.5 ${isPingingAll ? "animate-spin text-[var(--profit)]" : ""}`} />
            ...
            return (
              <div
                ...
                className={`p-4 rounded-xl border space-y-2.5 flex flex-col justify-between transition-all ${
                  isGwActive
                    ? "bg-[var(--bg)] border-[var(--profit)] ring-1 ring-[var(--border-strong)]"
                    : "bg-[var(--bg)] border-white/[0.08] hover:border-white/[0.16]"
                }`}
              >
                <div>
                  ...
                  <h3 className="text-xs font-bold text-[var(--text-1)] truncate">{gw.name}</h3>
                  <p className="text-[10px] text-[var(--text-2)] truncate mt-0.5">
                    ID: <strong className="text-[var(--text-1)]">{gw.provider_id}</strong>
                  </p>
                </div>
                ...
                <button
                  ...
                  className="w-full py-1.5 rounded-lg text-[11px] font-bold bg-[var(--surface-1)] hover:bg-[var(--surface-1)] text-[var(--text-1)] border border-white/[0.08] transition flex items-center justify-center gap-1.5 cursor-pointer mt-2"
                >
                  <RefreshCw className={`w-3 h-3 ${isGwPinging ? "animate-spin text-[var(--profit)]" : ""}`} />
