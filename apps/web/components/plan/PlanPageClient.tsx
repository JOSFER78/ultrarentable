    ...
    <div className="w-full space-y-3 font-sans pb-8">
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1 border-b border-[var(--border)] text-xs font-mono">
        ...
        >
          ...
          <span>Tablero de Tareas ({tablero?.total || 0}){tablero?.sin_verificar ? ` · ${tablero.sin_verificar} activas` : ""}</span>
        </button>
      ...
      {!activeDoc && (
        <>
          ...
          {/* PESTAÑA 1: PLAN COMPLETO (ORCHESTRATION/STATE/PLAN_MAESTRO.MD) */}
          {activeTab === "plan_completo" && (
            <div className="space-y-2">
