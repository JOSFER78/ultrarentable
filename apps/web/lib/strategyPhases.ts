...
export const STRATEGY_PHASES: StrategyPhase[] = [
  {
    ...
    legacyRoutes: ["/strategies", "/estrategias/1-motor-en-vivo"],
    icon: "⚡",
    badge: "FASTENGINE",
    color: "#38bdf8",
  ...
  },
  {
    ...
    canonicalRoute: "/candidatos",
    legacyRoutes: ["/candidatos", "/estrategias/2-explorador-excel"],
    icon: "📊",
    badge: "CANDIDATOS",
    color: "#818cf8",
  ...
  {
    id: 3,
    name: "Pipeline 11 Gates",
    label: "3. Pipeline 11 Gates (FSM)",
    shortLabel: "11 Gates",
    canonicalRoute: "/gates",
    legacyRoutes: ["/gates", "/estrategias/3-pipeline-11-gates"],
    icon: "🧬",
    badge: "11-GATES",
    color: "#63e1b4",
  ...
  },
  {
    ...
    legacyRoutes: ["/research", "/estrategias/4-panel-investigador"],
    icon: "🔬",
    badge: "LAB I+D",
    color: "#f59e0b",
  ...
  },
  {
    ...
    legacyRoutes: ["/portfolio", "/estrategias/6-meta-estrategia"],
    icon: "🧩",
    badge: "PORTFOLIO",
    color: "#a855f7",
