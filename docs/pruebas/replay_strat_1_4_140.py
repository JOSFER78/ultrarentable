"""Deterministic Replay Script for strat_1_4_140 (Strategy 1.4.140 (Dual-Pass OOS)).
...
CEDULA_PATH = Path("strat_1_4_140_cedula.json")

def replay():
    print("================================================================================")
    print("🔬 REPLAY DETERMINISTA FASTENGINE: Strategy 1.4.140 (Dual-Pass OOS) (strat_1_4_140)")
    print("================================================================================")
