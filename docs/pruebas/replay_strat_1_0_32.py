"""Deterministic Replay Script for strat_1_0_32 (Strategy 1.0.32).
...
CEDULA_PATH = Path("strat_1_0_32_cedula.json")

def replay():
    print("================================================================================")
    print("🔬 REPLAY DETERMINISTA FASTENGINE: Strategy 1.0.32 (strat_1_0_32)")
    print("================================================================================")
