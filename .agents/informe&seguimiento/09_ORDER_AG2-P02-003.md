...
## SSH / VPS
Long jobs MUST be detached/asynchronous. Record `remote_job_id`, command, target SHA, log path, state and real exit code. Never block 10–20 minutes waiting for a remote suite.
