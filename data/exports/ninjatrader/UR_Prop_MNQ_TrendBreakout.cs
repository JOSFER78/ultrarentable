...
// Strategy Name: UR_Prop_MNQ_TrendBreakout
// Asset: MNQ (Micro E-mini Nasdaq-100)
// Hard DLL: $1,000.00 | Max DD: $2,000.00
// ============================================================================
namespace NinjaTrader.NinjaScript.Strategies
{
    public class UR_Prop_MNQ_TrendBreakout : Strategy
    {
        private EMA fastEma;
        private EMA slowEma;
        ...
        [NinjaScriptProperty]
        [Range(1, 20)]
        [Display(Name="Quantity", Description="Contracts to trade (MNQ)", Order=1, GroupName="1. Risk & Sizing")]
        ...
        [NinjaScriptProperty]
        [Range(4, 500)]
        [Display(Name="Profit Target (Ticks)", Description="Target ticks (0.25 tick size)", Order=4, GroupName="2. Order Management")]
        public int ProfitTargetTicks { get; set; } = 100;

        [NinjaScriptProperty]
        [Range(4, 300)]
        [Display(Name="Stop Loss (Ticks)", Description="Stop ticks (0.25 tick size)", Order=5, GroupName="2. Order Management")]
        ...
        public int BreakEvenTriggerTicks { get; set; } = 60;
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "Ultrarentable Prop Firm Certified Strategy for MNQ. Hard DLL, Trailing DD & Auto Break-Even.";
                Name = "UR_Prop_MNQ_TrendBreakout";
        ...
        private async void CheckAndExecuteRemoteOrders()
        {
            try
            {
                string pollUrl = string.Format("{0}?account_name={1}&symbol={2}", SignalsPollUrl, Uri.EscapeDataString(Account.Name), Uri.EscapeDataString("MNQ"));
        ...
        private async void SendTelemetryWebhook(Execution execution, double price, int quantity, MarketPosition marketPosition, DateTime time)
        {
            try
            {
                string jsonStr = string.Format(
                    "\{\"strategy_name\":\"UR_Prop_MNQ_TrendBreakout\",\"symbol\":\"MNQ\",\"account_name\":\"0\",\"execution_id\":\"1\",\"side\":\"2\",\"price\":3,\"quantity\":4,\"daily_pnl_usd\":5,\"timestamp_utc\":\"6\"\}",
