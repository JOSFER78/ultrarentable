...
// Strategy Name: UR_Prop_ES_TrendBreakout
// Asset: ES (E-mini S&P 500)
// Hard DLL: $1,000.00 | Max DD: $2,000.00
// ============================================================================
namespace NinjaTrader.NinjaScript.Strategies
{
    public class UR_Prop_ES_TrendBreakout : Strategy
    {
        private EMA fastEma;
        private EMA slowEma;
        ...
        [NinjaScriptProperty]
        [Range(1, 20)]
        [Display(Name="Quantity", Description="Contracts to trade (ES)", Order=1, GroupName="1. Risk & Sizing")]
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "Ultrarentable Prop Firm Certified Strategy for ES. Hard DLL, Trailing DD & Auto Break-Even.";
                Name = "UR_Prop_ES_TrendBreakout";
        ...
        private async void CheckAndExecuteRemoteOrders()
        {
            try
            {
                string pollUrl = string.Format("{0}?account_name={1}&symbol={2}", SignalsPollUrl, Uri.EscapeDataString(Account.Name), Uri.EscapeDataString("ES"));
        ...
        private async void SendTelemetryWebhook(Execution execution, double price, int quantity, MarketPosition marketPosition, DateTime time)
        {
            try
            {
                string jsonStr = string.Format(
                    "\{\"strategy_name\":\"UR_Prop_ES_TrendBreakout\",\"symbol\":\"ES\",\"account_name\":\"0\",\"execution_id\":\"1\",\"side\":\"2\",\"price\":3,\"quantity\":4,\"daily_pnl_usd\":5,\"timestamp_utc\":\"6\"\}",
