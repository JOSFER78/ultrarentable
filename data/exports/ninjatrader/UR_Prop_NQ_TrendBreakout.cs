...
// Strategy Name: UR_Prop_NQ_TrendBreakout
// Asset: NQ (E-mini Nasdaq-100)
// Hard DLL: $1,000.00 | Max DD: $2,000.00
// ============================================================================
namespace NinjaTrader.NinjaScript.Strategies
{
    public class UR_Prop_NQ_TrendBreakout : Strategy
    {
        private EMA fastEma;
        private EMA slowEma;
        ...
        [NinjaScriptProperty]
        [Range(1, 20)]
        [Display(Name="Quantity", Description="Contracts to trade (NQ)", Order=1, GroupName="1. Risk & Sizing")]
        ...
        public int BreakEvenTriggerTicks { get; set; } = 48;
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "Ultrarentable Prop Firm Certified Strategy for NQ. Hard DLL, Trailing DD & Auto Break-Even.";
                Name = "UR_Prop_NQ_TrendBreakout";
        ...
        private async void CheckAndExecuteRemoteOrders()
        {
            try
            {
                string pollUrl = string.Format("{0}?account_name={1}&symbol={2}", SignalsPollUrl, Uri.EscapeDataString(Account.Name), Uri.EscapeDataString("NQ"));
        ...
        private async void SendTelemetryWebhook(Execution execution, double price, int quantity, MarketPosition marketPosition, DateTime time)
        {
            try
            {
                string jsonStr = string.Format(
                    "\{\"strategy_name\":\"UR_Prop_NQ_TrendBreakout\",\"symbol\":\"NQ\",\"account_name\":\"0\",\"execution_id\":\"1\",\"side\":\"2\",\"price\":3,\"quantity\":4,\"daily_pnl_usd\":5,\"timestamp_utc\":\"6\"\}",
